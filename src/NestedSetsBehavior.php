...
class NestedSetsBehavior extends Behavior
{
    ...
    const OPERATION_SAVE_ROOT = 'saveRoot';
    ...
    public function saveRoot($runValidation = false, $attributes = null)
    {
        $this->operation = self::OPERATION_SAVE_ROOT;
